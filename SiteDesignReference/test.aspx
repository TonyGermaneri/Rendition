        ...
        <script type="text/javascript">
            document.onreadystatechange = function () {
                if (document.readyState == "complete") {
                    Rendition.Commerce.ItemEditor({ itemNumber: '822.USA' });
                }
            } 
        </script>
<script type="text/javascript">
...
Rendition.Commerce.ItemEditor = function (args) {
    ...
    instance.init = function () {
        instance.reqEval = Rendition.UI.Ajax(Rendition.UI.clientServerSyncURI + instance.initURL(), function (e) {
            ...
            if (instance.newItem === undefined) {
                ...
                instance.menuBarElements[4] = Rendition.UI.MenuOption();
                instance.menuBarElements[4].text = Rendition.Localization['ItemEditor_AddSubItem'].Title;
                Rendition.UI.appendEvent('click', instance.menuBarElements[4], function (e) {
                    instance.addSubItem();
                    return false;
                }, false);
            }
    ...
    instance.addSubItem = function(){
        instance.subItemDialog = Rendition.UI.Dialog({
            rect: {
                x: Rendition.UI.dialogPosition.x,
                y: Rendition.UI.dialogPosition.y,
                h: 143,
            ...
            modal: true,
            title: Rendition.Localization['ItemEditor_AddSubItem'].Title
        });
        instance.subItemPattern = document.createElement('input');
        instance.submitSubItemButton = document.createElement('button');
        instance.submitSubItemButton.innerHTML = Rendition.Localization['ItemEditor_AddSubItemSubmit'].Title;
        instance.submitSubItemButton.style.cssFloat = 'right';
        instance.submitSubItemButton.style.margin = '4px';
        instance.subItemPairTable = Rendition.UI.pairtable({
            rows: [
			    [instance.subItemPattern]
		    ]
        });
        instance.subItemGroupBox = Rendition.UI.GroupBox({
            title: Rendition.Localization['ItemEditor_AddSubItemSelectSizesAndColors'].Title,
            childNodes: [instance.subItemPairTable.table],
            expanded: true,
            parentNode: instance.subItemDialog.content
        });
        instance.subItemDialog.content.appendChild(instance.submitSubItemButton);
    }
